...
class Mycal_model extends CI_Model {
    ...
    function Mycal_model() {
        ...
        $this->conf = array(
            'start_day'=>'sunday',
            'show_next_prev'=>true,
            'next_prev_url'=>'http://localhost:8889/CodeIgniter/index.php' . '/mycal/display'
        );
        $this->conf['template'] = '
        {table_open}<table border="0" cellpadding="0" cellspacing="0" class="calendar">{/table_open}

   {heading_row_start}<tr style="background-color: lightsteelblue; font-size: 16px">{/heading_row_start}
